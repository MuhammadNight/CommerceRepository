...
import { updateGamingData } from '../../store/slices/GamingSlice';

const EditDeleteGaming = () => {
    ...
    const handleUpdate = (values) => {
        ...
        dispatch(updateGamingData({ id: selectProductId, ...updatedValues }))
            .then(() => {
    ...
    return (
        <ModalAlert title={modalType === "update" ? "Edit Gaming Product" : "Confirm Deletion"}>
            {modalType === "update" ? (
                <Formik
                ...
                >
                    {({ isSubmitting }) => (
                        <Form className="p-4">
                            <h2 className="text-xl font-semibold mb-4">Edit Gaming Product Details</h2>
                ...
                <div className="p-4">
                    <h2 className="text-xl font-semibold mb-4">Do you want to delete this gaming product?</h2>
                    <div className="flex justify-end items-center gap-2 mt-4">
                        <button
                            onClick={() => dispatch(toggleModalAlert())}
                            className="py-2 px-4 rounded-md bg-blue-500 text-white hover:bg-blue-600"
...
export default EditDeleteGaming;
