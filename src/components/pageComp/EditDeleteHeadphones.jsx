...
import { updateHeadphoneData } from '../../store/slices/HeadphoneSlice'; 

const EditDeleteHeadphones = () => {
    ...
    const initialValues = {
        ...
        noise_canceling: selectedProduct.noise_canceling ? 'true' : 'false',
    ...
    const validationSchema = Yup.object({
        ...
        noise_canceling: Yup.string().oneOf(['true', 'false']).required('Noise Canceling status is required'),
    ...
    const handleUpdate = (values) => {
        const updatedValues = {
            ...
            noise_canceling: values.noise_canceling === 'true',
        };

        console.log("Updated Values:", updatedValues); 

        dispatch(updateHeadphoneData({ id: selectProductId, ...updatedValues }))
            .then(() => {
    ...
    return (
        <ModalAlert title={modalType === "update" ? "Edit Headphones" : "Confirm Deletion"}>
            {modalType === "update" ? (
                <Formik
                ...
                >
                    {({ isSubmitting }) => (
                        <Form className="p-4">
                            <h2 className="text-xl font-semibold mb-4">Edit Headphone Details</h2>
                ...
                <div className="p-4">
                    <h2 className="text-xl font-semibold mb-4">Do you want to delete these headphones?</h2>
                    <div className="flex justify-end items-center gap-2 mt-4">
                        <button
                            onClick={() => dispatch(toggleModalAlert())}
                            className="py-2 px-4 rounded-md bg-blue-500 text-white hover:bg-blue-600"
...
export default EditDeleteHeadphones;
