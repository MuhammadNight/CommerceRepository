        ...
        <div className="mx-4 sm:mx-8 md:mx-12 lg:mx-16 my-8">
            <div className="max-w-full sm:max-w-4xl md:max-w-5xl lg:max-w-7xl mx-auto p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-1/2 mt-6 lg:mt-0 lg:ml-8 flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center mt-6 md:grid-cols-3 lg:grid-cols-3">
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <MdSensors className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">Sensor:</div>
                                <span>{product?.sensor}</span>
                            </div>
                        </div>
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <MdFitScreen className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                        ...
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <GiSoundWaves className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">ISO range:</div>
                                <span>{product?.ISO_range}</span>
                            </div>
                        </div>
                    </div>
                    <div className="mt-6">
