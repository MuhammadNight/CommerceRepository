...
import { MdScreenshot, MdOutlineFlipCameraIos } from "react-icons/md";
                ...
                <div className="w-full lg:w-1/2 mt-6 lg:mt-0 lg:ml-8 flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-6 md:grid-cols-3 lg:grid-cols-3">
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <MdScreenshot className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">Screen size:</div>
                                <span>{product?.screen_size}</span>
                            </div>
                        </div>
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <BsFillCpuFill className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">CPU</div>
                        ...
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            ...
                            <div className="flex flex-col">
                                <div className="text-gray-700">Number of cores</div>
                                <span>{product?.number_of_cores}</span>
                            </div>
                        </div>
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <MdCameraAlt className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">Main camera:</div>
                                <span>{product?.Main_camera} MP</span>
                            </div>
                        </div>
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <MdOutlineFlipCameraIos className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">Front camera:</div>
                                <span>{product?.Front_camera} MP</span>
                            </div>
                        </div>
                        <div className="bg-[#F4F4F4] p-3 rounded-lg border flex items-center text-sm sm:text-base">
                            <GiBattery75 className="h-5 w-5 mr-2" />
                            <div className="flex flex-col">
                                <div className="text-gray-700">Battery capacity:</div>
