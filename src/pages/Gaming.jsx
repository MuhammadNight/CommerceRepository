...
import CreateGaming from "../components/pageComp/CreateGaming";
import { CgMoreVertical } from 'react-icons/cg';
import { FaEdit, FaTrash } from 'react-icons/fa';
import EditDeleteGaming from "../components/pageComp/EditDeleteGaming";
...
const Gaming = () => {
  ...
  const filteredProducts = products.filter((item) => item.CategoryId === 6);
  ...
  return (
    <div className="mx-8 my-8">
      ...
      {ShowModal && modalType === "create" && <CreateGaming />}
      {(ShowModal && (modalType === "update" || modalType === "delete")) && <EditDeleteGaming />}
    </div>
  );
};
