...
const Phones = () => {
  ...
  const filteredProducts = products.filter((item) => item.CategoryId === 1);
  ...
  return (
    <div className="mx-8 my-8">
      ...
      {ShowModal && modalType === "create" && <CreatePhone />}
      {(ShowModal && (modalType === "update" || modalType === "delete")) && <EditDeletePhone />}
    </div>
  );
};
