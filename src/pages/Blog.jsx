...
const Blog = () => {
  return (
    <section class="text-gray-600 body-font">
      <div className="flex flex-col text-center w-full mb-12 pt-[20px]">
        <h1 className="text-3xl font-medium title-font mb-4 text-gray-900">Our Blog</h1>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
          Stay updated with the latest news, reviews, and insights in the world of electronics and technology.
        </p>
      </div>
