...
import CreatePhone from "../components/pageComp/CreatePhone";
import { CgMoreVertical } from 'react-icons/cg';
import { FaEdit, FaTrash } from 'react-icons/fa';
import EditDeletePhone from "../components/pageComp/EditDeletePhone";
import CreateComputer from "../components/pageComp/CreateComputer";
import EditDeleteComputer from "../components/pageComp/EditDeleteComputer";
...
const Computers = () => {
  ...
  const filteredProducts = products.filter((item) => item.CategoryId === 5);
  ...
  return (
    <div className="mx-8 my-8">
      ...
      {ShowModal && modalType === "create" && <CreateComputer />}
      {(ShowModal && (modalType === "update" || modalType === "delete")) && <EditDeleteComputer />}
    </div>
  );
};
