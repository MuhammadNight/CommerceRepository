...
import CreateCamera from "../components/pageComp/CreateCamera";
import { CgMoreVertical } from 'react-icons/cg';
import { FaEdit, FaTrash } from 'react-icons/fa';
import EditDeleteCamera from "../components/pageComp/EditDeleteCamera";
...
const Cameras = () => {
  ...
  const filteredProducts = products.filter((item) => item.CategoryId === 3);
  ...
  return (
    <div className="mx-8 my-8">
      ...
      {ShowModal && modalType === "create" && <CreateCamera />}
      {(ShowModal && (modalType === "update" || modalType === "delete")) && <EditDeleteCamera />}
    </div>
  );
};
