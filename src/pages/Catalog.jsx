    ...
    return (
        <div className="mx-8 my-8">
            ...
            <div className="grid mx-8 my-8 lg:grid-cols-4 md:grid-cols-3 grid-cols-2  gap-4 mt-[30px]">
                <NavLink to="/phones">
                    <div className="flex w-[125px] h-[88px] md:w-[150px] md:h-[118px] lg:w-[160px] lg:h-[128px] bg-[#EDEDED] rounded-md hover:bg-gray-300 cursor-pointer duration-200 active:scale-95 p-4 shadow-md justify-center items-center flex-col">
