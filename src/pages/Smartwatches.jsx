...
import CreateSmartwatch from "../components/pageComp/CreateSmartwatch";
import { CgMoreVertical } from 'react-icons/cg';
import { FaEdit, FaTrash } from 'react-icons/fa';
import EditDeleteSmartwatch from "../components/pageComp/EditDeleteSmartwatch";
...
const Smartwatches = () => {
  ...
  const filteredProducts = products.filter((item) => item.CategoryId === 2);
  ...
  return (
    <div className="mx-8 my-8">
      ...
      {ShowModal && modalType === "create" && <CreateSmartwatch />}
      {(ShowModal && (modalType === "update" || modalType === "delete")) && <EditDeleteSmartwatch />}
    </div>
  );
};
